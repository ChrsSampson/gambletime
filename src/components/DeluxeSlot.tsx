...
export default function DeluxeSlot({
  ...
  function calculateWinnings() {
    ...
    if (bonusCount > 0) {
      ...
      setMessage(
        `You got ${bonusCount} bonus spin${bonusCount > 1 ? "s" : ""}!`
      );
      return;
    }
  ...
  return (
    <div className="border rounded p-4">
      ...
      <div className="flex gap-2 justify-center place-items-center">
        ...
        <input
          disabled={freeSpins > 0 || !message}
          className="border rounded p-1 disabled:text-gray-300 disabled:border-gray-400 disabled:bg-gray-600"
          placeholder="Bet..."
          value={bet}
        ...
        {freeSpins > 0 && (
          <span className="bold text-lg font-bold">
            Bonus Spins: {freeSpins}
          </span>
        )}
      </div>
      <sub className="italic text-center">
        Bets are locked in during bonus spins
      </sub>
